...
audio_chunks_of1sec = data.split(False)
...
x = Convolution1D(16, 40, activation='relu', border_mode='same')(input_img)
...
# at this point the representation is (110, 4) i.e. 440-dimensional
